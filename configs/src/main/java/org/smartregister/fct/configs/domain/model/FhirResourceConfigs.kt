...
data class FhirResourceConfig(
    var baseResource: ResourceConfig? = null,
...
data class ResourceConfig(
    ...
    val attributesToUpdate: List<KeyValueConfig>? = null,
    val filterFhirPathExpressions: List<KeyValueConfig>? = null,
)

@Serializable
data class CountResultConfig(val sumCounts: Boolean = true)
