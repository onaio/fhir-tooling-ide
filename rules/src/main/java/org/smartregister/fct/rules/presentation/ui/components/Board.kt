...
fun Board(
    ...
    Box(Modifier.scale(scale).wrapContentSize(unbounded = true).onPointerEvent(PointerEventType.Scroll) {
...
private fun Modifier.patternBackground(color: Color) : Modifier {
    ...
    LaunchedEffect(image) {
        image.value = Image.makeFromEncoded(Res.readBytes("drawable/pattern.png")).toComposeImageBitmap()
    }
