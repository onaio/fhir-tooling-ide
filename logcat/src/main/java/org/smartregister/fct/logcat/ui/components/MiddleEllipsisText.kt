...
import org.smartregister.fct.logcat.data.helper.BreakIterator
import org.smartregister.fct.logcat.data.helper.DesktopBreakIterator
...
fun MiddleEllipsisText(
    ...
    if (text.isEmpty()) {
        ...
        val breakIterator: BreakIterator = DesktopBreakIterator()
